...
parser.add_argument('-c', '--config', default='configs/ft/parkinson_action_classification.json', type=str,
...
def main_worker(gpu, args):
    ...
    trainer = Multi_Trainer_Action_Classification(args, model, loss, metrics, optimizer, scheduler, gpu,
                      config=config,
